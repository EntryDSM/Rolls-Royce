...
public class ChangeGraduationInformationRequest {
    ...
    @Length(max = 5, message = "student_number는 5자 이하여야 합니다.") @Pattern(regexp = NUMERIC_REGEXP, message = "student_number는 숫자여야합니다.")
    private String studentNumber;

    @Length(max = 7, min = 7, message = "schoolCode는 7자여야 합니다.") private String schoolCode;
