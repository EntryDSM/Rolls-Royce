...
public class AdminFacade {
    ...
    public void findAdmin() {
        adminRepository.findById(getEmail()).orElseThrow(() -> AdminNotFoundException.EXCEPTION);
    }

    public Admin getAdmin() {
        return adminRepository.findById(getEmail()).orElseThrow(() -> AdminNotFoundException.EXCEPTION);
    }
