...
public class NewApplicantsExcelService {
	...
	private void insertInfo(int DH, User user, Graduation graduation, GraduationCase graduationCase, Status
		status, Score score) {
		//기본정보
		...
		applicantInformation.getCell(DH+1, 6).setCellValue(getEducationalStatus(user.getEducationalStatus()));
		applicantInformation.getCell(DH+1, 7).setCellValue(String.valueOf(graduation != null ? graduation.getGraduatedAt().getYear() : "-"));

		applicantInformation.getCell(DH+3, 1).setCellValue(getApplicationType(user.getApplicationType()));
		...
		applicantInformation.getCell(DH+4, 1).setCellValue(Boolean.TRUE.equals(user.getIsDaejeon()) ? "대전" : "전국");
		...
		applicantInformation.getCell(DH+5, 1).setCellValue(getApplicationRemark(user.getApplicationRemark()));
		applicantInformation.getCell(DH+5, 2).setCellValue(Sex.MALE.equals(user.getSex()) ? "남자" : "여자");
	...
	private void insertScore(int DH, GraduationCase graduationCase, Score score) {
		...
		//점수
		applicantInformation.getCell(DH+15, 2).setCellValue(score.getThirdGradeScore().doubleValue());
		applicantInformation.getCell(DH+15, 4).setCellValue(score.getThirdBeforeScore().doubleValue());
		applicantInformation.getCell(DH+15, 5).setCellValue(score.getThirdBeforeBeforeScore().doubleValue());
		applicantInformation.getCell(DH+15, 7).setCellValue(score.getTotalGradeScore().doubleValue());

		applicantInformation.getCell(DH+18, 1).setCellValue(graduationCase != null ? graduationCase.getVolunteerTime().toString() : "-");
		applicantInformation.getCell(DH+18, 2).setCellValue(score.getVolunteerScore().doubleValue());
		applicantInformation.getCell(DH+18, 3).setCellValue(graduationCase != null ? graduationCase.getDayAbsenceCount() : 0);
		applicantInformation.getCell(DH+18, 4).setCellValue(graduationCase != null ? graduationCase.getLatenessCount() : 0);
		applicantInformation.getCell(DH+18, 5).setCellValue(graduationCase != null ? graduationCase.getLectureAbsenceCount() : 0);
		applicantInformation.getCell(DH+18, 6).setCellValue(graduationCase != null ? graduationCase.getEarlyLeaveCount() : 0);
