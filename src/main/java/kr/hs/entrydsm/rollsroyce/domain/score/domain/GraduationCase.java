...
public class GraduationCase extends ApplicationCase {
    ...
    private BigDecimal[] gradeScoreFormula() {
        ...
        //        System.out.println("b " + scoresToCalculate[0] + " / "+ scoresToCalculate[1] + " / "+
        // scoresToCalculate[2] + " / "+ scoresToCalculate[3] + " / ");
        ////
